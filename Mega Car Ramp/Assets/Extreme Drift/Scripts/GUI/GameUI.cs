...
public class GameUI : MonoBehaviour
{
    ...
    [HideInInspector]
    public bool gameStarted, gamePaused, gameRest, gameFinished = false,gameFailed;
    [HideInInspector]
   ...
   public bool carPenalty=false;
    ...
    #region References_CheckPoint

    public int CheckPoint_Count = 0;
    [SerializeField] Text CurrentCollectedCheckPoint;
    [SerializeField] bool CheckPoint_Mode;
    #endregion

    #region References_Speed

    public Text PlayerPosition;
    public bool Speed_Position_Mode;
    ...
    void Checkpoint()
    {
        if (CheckPoint_Mode)
        {
            CurrentCollectedCheckPoint.text = CheckPoint_Count.ToString()+"/3";
        }
    }
